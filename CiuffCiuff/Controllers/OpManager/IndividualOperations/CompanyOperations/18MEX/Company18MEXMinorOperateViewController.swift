//
//  G18MEXMinorOperateViewController.swift
//  CiuffCiuff
//
...
class Company18MEXMinorOperateViewController: UIViewController, Operable {
    ...
    func payout(withAmount amount: Int) -> Bool {
        ...
        let opsToBePerformed = CompanyOperateViewController.generatePayoutOperations(withAmount: amount, forCompanyAtBaseIndex: self.operatingCompanyBaseIndex, andGameState: self.gameState, shouldIncludeMarketOps: false, withOperationUid: nil, isBasicStandardPayoutWiththold: true)
