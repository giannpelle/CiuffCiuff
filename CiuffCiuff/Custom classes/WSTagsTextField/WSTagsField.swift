...
open class WSTagsField: UIScrollView {
    ...
    @IBInspectable open var placeholder: String = "Add player..." {
        didSet {
...
extension WSTagsField {
    ...
    fileprivate func internalInit() {
        ...
        textField.textColor = UIColor.primaryAccentColor
...
extension WSTagsField: UITextFieldDelegate {
    public func textFieldShouldBeginEditing(_ textField: UITextField) -> Bool {
        return textDelegate?.textFieldShouldBeginEditing?(textField) ?? true
    }
